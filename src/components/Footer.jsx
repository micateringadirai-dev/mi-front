      ...
      <div className="container footer__grid">
        ...
        <div className="footer__ad-col">
          ...
          <div className="footer-partner-card">
            <div className="footer-partner-label">
              <span className="partner-badge">✦ One Step Beyond</span>
            </div>
            <p className="footer-partner-desc">
              Website Designed &amp; Developed by <strong>OSB</strong>
            </p>
            <div className="footer-partner-links">
              <a
                href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20OSB%2C%20I%20visited%20MI%20Groups%20website%20and%20would%20like%20to%20know%20more%20about%20your%20services.`}
                target="_blank"
                rel="noopener noreferrer"
                className="footer-partner-btn footer-partner-btn--wa"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="footer-partner-btn footer-partner-btn--ig"
