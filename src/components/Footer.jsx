...
const WHATSAPP_NUMBER = '919942272631';
  ...
  return (
    <footer className="footer">
      <div className="container footer__grid">
        ...
        <div className="footer__ad-col">
          <h4>Digital Partner</h4>
          <div className="footer-ad-card">
            <div className="footer-ad-card__img-wrap">
              <img
                src={adCardImg}
                alt="One Step Beyond – Digital Partner"
                className="footer-ad-card__img"
                onError={(e) => {
              ...
              />
              <span className="footer-ad-card__badge">✦ Web Partner</span>
            </div>

            <div className="footer-ad-card__body">
              <p className="footer-ad-card__title">
                Want a <span>website like this</span>?
              </p>
              <p className="footer-ad-card__sub">
                We build it for your business! — <strong>OSB</strong>
              </p>

              <div className="footer-ad-card__actions">
                <a
                  href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hi%20OSB%2C%20I%20visited%20MI%20Groups%20website%20and%20would%20like%20to%20know%20more%20about%20your%20website%20development%20services.`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="footer-ad-card__btn footer-ad-card__btn--wa"
                  aria-label="Chat with OSB on WhatsApp"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="footer-ad-card__btn footer-ad-card__btn--ig"
                  aria-label="Follow OSB on Instagram"
                >
                  <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
